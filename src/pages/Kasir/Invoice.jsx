...
export default function Invoice() {
  ...
  return (
    <div ref={componentRef} className="grid grid-cols-4 gap-4">
      ...
      <div className="bg-green-50 col-span-2 float-right">
        <ReactToPrint
          trigger={() => (
            <button className="bg-red-300 hover:bg-red-400 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-300">
              Cetak Nota
            </button>
          )}
